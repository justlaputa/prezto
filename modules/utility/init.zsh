...
alias 'up'='brew upgrade --force --greedy'
alias 'vpcn'='ssh vps3 trash-empty'
alias 'vpls'='ssh vps3 "ls -lhSr ~/Downloads/*"'
alias 'vprm'='ssh vps3 trash "./Downloads/av/*"'
alias 'vps'='ssh vps3'
alias 'vpsmove'='ssh vps3 find ./Downloads/finished -size +100M -name "*.mp4" -exec mv {} ./Downloads/av/ \;'
