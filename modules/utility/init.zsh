...
alias dpB='docker-compose build --no-cache'
alias dpd='docker-compose down'
alias dpe='docker-compose exec'
alias dpk='docker-compose kill'
alias dpl='docker-compose logs'
alias dpls='docker-compose ps'
alias dpp='docker-compose pause'
alias dpP='docker-compose unpause'
alias dppl='docker-compose pull'
alias dpph='docker-compose push'
alias dpps='docker-compose ps'
alias dpr='docker-compose run'
alias dpR='docker-compose run --rm'
alias dprm='docker-compose rm'
alias dps='docker-compose start'
alias dpsc='docker-compose scale'
alias dpS='docker-compose restart'
alias dpu='docker-compose up'
alias dpU='docker-compose up -d'
alias dpv='docker-compose version'
alias dpx='docker-compose stop'
